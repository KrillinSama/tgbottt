...
from axel import dispatcher, updater, TOKEN, WEBHOOK, OWNER_ID, DONATION_LINK, CERT_PATH, PORT, URL, LOGGER, \
    ALLOW_EXCL
# needed to dynamically load modules
# NOTE: Module order is not guaranteed, specify that in the config file!
from axel.modules import ALL_MODULES
from axel.modules.helper_funcs.chat_status import is_user_admin
from axel.modules.helper_funcs.misc import paginate_modules
...
Want to follow my news channel? [Click here](http://t.me/axelsource)!
"""
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("axel.modules." + module_name)
...
def donate(bot: Bot, update: Update):
    ...
    if chat.type == "private":
        ...
        update.effective_message.reply_text("Thanks 😁.",
                                                parse_mode=ParseMode.MARKDOWN, disable_web_page_preview=True)
