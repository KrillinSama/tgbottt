...
from telegram import Message, Chat, Update, Bot, MessageEntity, User
from telegram import ParseMode
from telegram.ext import CommandHandler, run_async, Filters
from telegram.ext.dispatcher import run_async
from telegram.utils.helpers import escape_markdown, mention_html

from axel import dispatcher, OWNER_ID, SUDO_USERS, SUPPORT_USERS, WHITELIST_USERS, BAN_STICKER
...
from axel.modules.helper_funcs.chat_status import bot_admin
...
RUNS_HANDLER = DisableAbleCommandHandler("runs", runs, filters=Filters.chat(OWNER_ID))
SLAP_HANDLER = DisableAbleCommandHandler("slap", slap, filters=Filters.chat(OWNER_ID))
...
GETLINK_HANDLER = CommandHandler("link", getlink, pass_args=True, filters=CustomFilters.sudo_filter)
