...
import axel.modules.sql.welcome_sql as sql
from axel import dispatcher, OWNER_ID, LOGGER, SUDO_USERS, SUPPORT_USERS
from axel.modules.helper_funcs.chat_status import user_admin, can_delete, is_user_ban_protected
from axel.modules.helper_funcs.misc import build_keyboard, revert_buttons
from axel.modules.helper_funcs.msg_types import get_welcome_type
from axel.modules.helper_funcs.misc import send_to_list
from axel.modules.helper_funcs.string_handling import markdown_parser, \
    escape_invalid_curly_brackets
from axel.modules.log_channel import loggable
from axel.modules.feds import welcome_fed
    ...
    if should_welc:
        ...
        for new_mem in new_members:
            ...
            # Make bot greet admins
                ...
                update.effective_message.reply_text("Hey there! Thank you for adding me to your group, and be sure to check /help in PM for more commands and tricks!")
...
def user_button(bot: Bot, update: Update):
    ...
    if join_user == user.id:
        query.answer(text="Now You Can Speak!")
...
*Admin only:*
 ...
 - /rmwelcome <on/off>: On new member, try to delete the previous welcome message to avoid spamming the chat.
 - /welcomemute <on/off>: Mute people when they join until they prove they're not bots.
 - /welcomehelp: view more formatting information for custom welcome/goodbye messages.
 - /antispam <on/off> : protect group from spambot & spam accounts thats in bot database.
...
CLEAN_WELCOME = CommandHandler("rmwelcome", clean_welcome, pass_args=True, filters=Filters.group)
